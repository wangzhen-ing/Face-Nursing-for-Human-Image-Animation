...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", type=str, default="/cpfs01/projects-HDD/cfff-6f3a36a0cd1e_HDD/zsy_43187/champ/workspaces/wangzhen/code/champ-train-dev/configs/train/stage2_addface.yaml")
    ...
    train_dataloader = torch.utils.data.DataLoader(
        train_dataset, batch_size=16, shuffle=False, num_workers=8
    )

    for _, batch in enumerate(train_dataloader):
        for batch_idx, (ref_img, clip_img, face_embedding, face_clip_img, face_vae_img) in enumerate(zip(
                        batch["ref_img"],
                        batch["clip_img"],
