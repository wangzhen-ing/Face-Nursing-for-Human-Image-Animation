...
from models.gaussian_smoothing import GaussianSmoothing


#NOTE(wz) reference image + Guassian(target image) as reference image
...
class MultiGuidanceIPFine2ImagePipeline_train(DiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # smoothing = GaussianSmoothing(channels=3, kernel_size=3, sigma=0.5, dim=2).cuda()
        ...
        ref_image_latents = ref_image_latents1 + ref_image_latents
