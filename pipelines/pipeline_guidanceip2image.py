...
class MultiGuidanceIP2ImagePipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        guidance_encoder_dwpose_woface,
        image_encoder_ip,
        image_proj_model,
        scheduler: Union[
            DDIMScheduler,
        ...
        self.register_modules(
            ...
            guidance_encoder_dwpose_woface=guidance_encoder_dwpose_woface,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        region_clip_image = self.clip_image_processor.preprocess(
            region_image.resize((224, 224)), return_tensors="pt"
        ).pixel_values
        ...
        id_embeds = torch.from_numpy(face_app.get(id_image)[0].normed_embedding).unsqueeze(0).to(device, dtype=self.image_encoder_ip.dtype)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.denoising_unet(
                    latent_model_input,
                    t,
                    encoder_hidden_states=(image_prompt_embeds, ip_tokens),
